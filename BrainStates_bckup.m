function out = BrainStates2(OutPathBrainStates,OutputPathTable,FileNameDB, T, indDB, varargin)
%function out = FunctionName(FileBase ,fMode, Arg1, Arg2)
%here is the help message :
[fMode, MinThetaDeltaRatio, MinTimeRatio, MinSpindleDeltaRatio,MinDurationHVS_sec,ThetaBand,HVSband,interactive] = DefaultArgs(varargin,{'compute',0.8, 20,4.5,1, [[3,5];[6,9]], [[0,4];[11 30]],'off'});

display(MinThetaDeltaRatio)
display(MinSpindleDeltaRatio)
