...
[fMode, NumICs,BrainState,val,MinDurationStates,TimeScaleGlue,FreqBands,ThRoughness,interactiveDisplay,PhAmpKlustersAnimal] = DefaultArgs(varargin,{'compute',30,[],[],40,0.2,{'isa','delta','theta','spindle','beta','lowgamma','highgamma'},1,'off',[]}); %'isa','delta','theta','spindle','beta','lowgamma','highgamma'
display(fMode)
display(NumICs)
